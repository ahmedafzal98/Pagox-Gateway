...
class MainAdapter extends BaseExpandableListAdapter {
    ...
    public MainAdapter(Context context, List<MenuModel> listDataHeader, HashMap<MenuModel, List<MenuModel>> listDataChild) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        TextView lblListHeader = convertView.findViewById(R.id.list_parent);
